...
{
	// Unpack the values we need from void pointers
	int pA = ((Process*)this)->priority;
	int pB = ((Process*)that)->priority;
	int aA = ((Process*)this)->arrival_time;
	int aB = ((Process*)that)->arrival_time;

	//Sort first by priority, then by arrival time
